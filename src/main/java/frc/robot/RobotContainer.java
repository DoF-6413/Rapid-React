...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    new JoystickButton(m_xbox, XboxController.Button.kA.value)
        .whenPressed(
            new RunCommand(() -> m_climberSubsystem.goUpManual(Constants.manualClimberSpeedUp), m_climberSubsystem))
    ...
    new JoystickButton(m_xbox, XboxController.Button.kB.value)
        .whenPressed(
            new RunCommand(() -> m_climberSubsystem.goDownManual(Constants.manualClimberSpeedDown), m_climberSubsystem))
        .whenReleased(new RunCommand(() -> m_climberSubsystem.stop(), m_climberSubsystem));

    new JoystickButton(m_driverXbox, XboxController.Button.kY.value)
        .whenPressed(
            new RunCommand(() -> m_intakeSubsystem.setAllActuatorsUp(Constants.actuatorsSpeed), m_intakeSubsystem))
    ...
    new JoystickButton(m_driverXbox, XboxController.Button.kX.value)
        .whenPressed(
            new RunCommand(() -> m_intakeSubsystem.setAllActuatorsDown(Constants.actuatorsSpeed), m_intakeSubsystem))
        .whenReleased(new RunCommand(() -> m_intakeSubsystem.stopActuators(), m_intakeSubsystem));

    // Left Middle Button on Aux Control Resets CLimber (Brings climber allthe way
    // down and sets encoder value to 0)
    new JoystickButton(m_xbox, XboxController.Button.kStart.value)
        .whenPressed(new ClimberReset(m_climberSubsystem));
    ...
    new JoystickButton(m_xbox, XboxController.Button.kBack.value)
        .whenPressed(new EndGameClimbTraverse(m_climberSubsystem, m_intakeSubsystem, m_gyroSubsystem));
    ...
    new JoystickButton(m_driverXbox, XboxController.Button.kA.value)
        .whenPressed(new ClimberGoTo(47, m_climberSubsystem));
    ...
    new JoystickButton(m_driverXbox, XboxController.Button.kB.value)
        .whenPressed(new ClimberGoTo(0, m_climberSubsystem));
    ...
    leftTrigger
        .whenActive(new EndGameClimbHigh(m_climberSubsystem, m_intakeSubsystem, m_gyroSubsystem));
