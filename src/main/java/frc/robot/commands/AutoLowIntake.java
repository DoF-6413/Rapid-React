...
public class AutoLowIntake extends SequentialCommandGroup {
  /** Creates a new OttoCommand. */
  public AutoLowIntake(DrivetrainSubsystem drive, ShooterSubsystem shoot, IndexerSubsystem Index, IntakeSubsystem intake) {
